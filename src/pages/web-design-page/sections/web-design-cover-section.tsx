...
import webDesignHeaderText from '../../../assets/service-header-texts/web-design.svg'

const WebDesignCoverSection = () => {
...
export default WebDesignCoverSection
